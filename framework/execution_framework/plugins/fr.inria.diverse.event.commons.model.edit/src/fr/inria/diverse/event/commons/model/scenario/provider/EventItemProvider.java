...
/**
 * This is the item provider adapter for a {@link fr.inria.diverse.event.commons.model.scenario.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_target_feature", "_UI_Event_type"),
				 ScenarioPackage.Literals.EVENT__TARGET,
				 true,
				 false,
				 true,
				 null,
