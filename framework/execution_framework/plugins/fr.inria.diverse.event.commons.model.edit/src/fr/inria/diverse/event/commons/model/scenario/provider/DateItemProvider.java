...
/**
 * This is the item provider adapter for a {@link fr.inria.diverse.event.commons.model.scenario.Date} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateItemProvider extends PhaseItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScenarioPackage.Literals.DATE__TIME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Date_type") + " " + date.getTime();
	}
