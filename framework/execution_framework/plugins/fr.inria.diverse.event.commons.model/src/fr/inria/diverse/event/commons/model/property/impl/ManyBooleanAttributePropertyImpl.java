 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.event.commons.model.property.impl.ManyBooleanAttributePropertyImpl#getQuantifier <em>Quantifier</em>}</li>
 *   <li>{@link fr.inria.diverse.event.commons.model.property.impl.ManyBooleanAttributePropertyImpl#isValue <em>Value</em>}</li>
 *   <li>{@link fr.inria.diverse.event.commons.model.property.impl.ManyBooleanAttributePropertyImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ManyBooleanAttributePropertyImpl<T> extends ClassPropertyImpl<T> implements ManyBooleanAttributeProperty<T> {
	/**
