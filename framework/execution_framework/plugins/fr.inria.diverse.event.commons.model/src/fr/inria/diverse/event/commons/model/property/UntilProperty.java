 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.event.commons.model.property.UntilProperty#getLeftFormula <em>Left Formula</em>}</li>
 *   <li>{@link fr.inria.diverse.event.commons.model.property.UntilProperty#getRightFormula <em>Right Formula</em>}</li>
 * </ul>
 *
 * @see fr.inria.diverse.event.commons.model.property.PropertyPackage#getUntilProperty()
 * @model abstract="true"
 * @generated
 */
public interface UntilProperty<P extends AbstractProperty> extends TemporalProperty {
	 ...
	 * @see fr.inria.diverse.event.commons.model.property.PropertyPackage#getUntilProperty_LeftFormula()
	...
	/**
	 * Sets the value of the '{@link fr.inria.diverse.event.commons.model.property.UntilProperty#getLeftFormula <em>Left Formula</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.inria.diverse.event.commons.model.property.PropertyPackage#getUntilProperty_RightFormula()
	 * @model containment="true"
	 * @generated
	 */
	P getRightFormula();
	...
	/**
	 * Sets the value of the '{@link fr.inria.diverse.event.commons.model.property.UntilProperty#getRightFormula <em>Right Formula</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
