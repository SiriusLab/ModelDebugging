...
public class ScenarioFactoryImpl extends EFactoryImpl implements ScenarioFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ScenarioPackage.ARBITER_STATE: return createArbiterState();
			case ScenarioPackage.ARBITER_TRANSITION: return createArbiterTransition();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ScenarioPackage.TRUTH_VALUE:
	 ...
	 * @generated
	 */
	public <P extends Property, T extends ArbiterTransition<P, ?>> ArbiterState<P, T> createArbiterState() {
		ArbiterStateImpl<P, T> arbiterState = new ArbiterStateImpl<P, T>();
		return arbiterState;
	}
	 ...
	 * @generated
	 */
	public <P extends Property, S extends ArbiterState<P, ?>> ArbiterTransition<P, S> createArbiterTransition() {
		ArbiterTransitionImpl<P, S> arbiterTransition = new ArbiterTransitionImpl<P, S>();
		return arbiterTransition;
	}
