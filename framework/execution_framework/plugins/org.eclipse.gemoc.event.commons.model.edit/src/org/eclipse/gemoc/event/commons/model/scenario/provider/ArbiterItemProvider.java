...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.event.commons.model.scenario.Arbiter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArbiterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ScenarioPackage.Literals.ARBITER__INITIAL_STATE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAcceptingStatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arbiter_acceptingStates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arbiter_acceptingStates_feature", "_UI_Arbiter_type"),
				 ScenarioPackage.Literals.ARBITER__ACCEPTING_STATES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arbiter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arbiter_name_feature", "_UI_Arbiter_type"),
				 ScenarioPackage.Literals.ARBITER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScenarioPackage.Literals.ARBITER__STATES);
			childrenFeatures.add(ScenarioPackage.Literals.ARBITER__TRANSITIONS);
		}
	...
	public String getText(Object object) {
		String label = ((Arbiter<?, ?, ?>)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Arbiter_type") :
			getString("_UI_Arbiter_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.ARBITER__STATES,
				 ScenarioFactory.eINSTANCE.createArbiterState()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.ARBITER__TRANSITIONS,
				 ScenarioFactory.eINSTANCE.createArbiterTransition()));
	}
