...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.event.commons.model.property.PropertyReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyReferenceItemProvider extends PropertyItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyReference_referencedProperty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyReference_referencedProperty_feature", "_UI_PropertyReference_type"),
				 PropertyPackage.Literals.PROPERTY_REFERENCE__REFERENCED_PROPERTY,
				 true,
				 false,
				 true,
				 null,
