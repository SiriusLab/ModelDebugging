 ...
 * <ul>
 *   <li>{@link org.gemoc.executionframework.xdsml_base.impl.ProjectResourceImpl#getProjectName <em>Project Name</em>}</li>
 *   <li>{@link org.gemoc.executionframework.xdsml_base.impl.ProjectResourceImpl#getProjectKind <em>Project Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ProjectResourceImpl extends MinimalEObjectImpl.Container implements ProjectResource {
	/**
	...
	protected EClass eStaticClass() {
		return Xdsml_basePackage.Literals.PROJECT_RESOURCE;
	}
	...
	public void setProjectName(String newProjectName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xdsml_basePackage.PROJECT_RESOURCE__PROJECT_NAME, oldProjectName, projectName));
	}
	...
	public void setProjectKind(ProjectKind newProjectKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Xdsml_basePackage.PROJECT_RESOURCE__PROJECT_KIND, oldProjectKind, projectKind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Xdsml_basePackage.PROJECT_RESOURCE__PROJECT_NAME:
				return getProjectName();
			case Xdsml_basePackage.PROJECT_RESOURCE__PROJECT_KIND:
