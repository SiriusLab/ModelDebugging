...
/**
 * This is the item provider adapter for a {@link org.gemoc.executionframework.xdsml_base.XTextEditorProject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XTextEditorProjectItemProvider
	 ...
	 * @generated
	 */
	public XTextEditorProjectItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Xdsml_basePackage.Literals.XTEXT_EDITOR_PROJECT__GRAMMAR_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns XTextEditorProject.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XTextEditorProject"));
	}
	...
	public String getText(Object object) {
		String label = ((XTextEditorProject)object).getProjectName();
		return label == null || label.length() == 0 ?
			getString("_UI_XTextEditorProject_type") :
			getString("_UI_XTextEditorProject_type") + " " + label;
	}
