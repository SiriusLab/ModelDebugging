 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getLanguageName <em>Language Name</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getResourceURI <em>Resource URI</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getAirdResourceURI <em>Aird Resource URI</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getMethodEntryPoint <em>Method Entry Point</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getModelEntryPoint <em>Model Entry Point</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getInitializationMethod <em>Initialization Method</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getInitializationArguments <em>Initialization Arguments</em>}</li>
 *   <li>{@link org.gemoc.executionframework.engine.mse.impl.LaunchConfigurationImpl#getAddonExtensions <em>Addon Extensions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LaunchConfigurationImpl extends MinimalEObjectImpl.Container implements LaunchConfiguration {
	...
	public void setLanguageName(String newLanguageName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__LANGUAGE_NAME, oldLanguageName, languageName));
	}
	...
	public void setResourceURI(String newResourceURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__RESOURCE_URI, oldResourceURI, resourceURI));
	}
	...
	public void setAirdResourceURI(String newAirdResourceURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__AIRD_RESOURCE_URI, oldAirdResourceURI, airdResourceURI));
	}
	...
	public void setMethodEntryPoint(String newMethodEntryPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__METHOD_ENTRY_POINT, oldMethodEntryPoint, methodEntryPoint));
	}
	...
	public void setModelEntryPoint(String newModelEntryPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__MODEL_ENTRY_POINT, oldModelEntryPoint, modelEntryPoint));
	}
	...
	public void setInitializationMethod(String newInitializationMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__INITIALIZATION_METHOD, oldInitializationMethod, initializationMethod));
	}
	...
	public void setInitializationArguments(String newInitializationArguments) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MsePackage.LAUNCH_CONFIGURATION__INITIALIZATION_ARGUMENTS, oldInitializationArguments, initializationArguments));
	}
	...
	public EList<String> getAddonExtensions() {
		if (addonExtensions == null) {
			addonExtensions = new EDataTypeUniqueEList<String>(String.class, this, MsePackage.LAUNCH_CONFIGURATION__ADDON_EXTENSIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MsePackage.LAUNCH_CONFIGURATION__LANGUAGE_NAME:
				return getLanguageName();
			case MsePackage.LAUNCH_CONFIGURATION__RESOURCE_URI:
				return getResourceURI();
			case MsePackage.LAUNCH_CONFIGURATION__AIRD_RESOURCE_URI:
				return getAirdResourceURI();
			case MsePackage.LAUNCH_CONFIGURATION__METHOD_ENTRY_POINT:
				return getMethodEntryPoint();
			case MsePackage.LAUNCH_CONFIGURATION__MODEL_ENTRY_POINT:
				return getModelEntryPoint();
			case MsePackage.LAUNCH_CONFIGURATION__INITIALIZATION_METHOD:
				return getInitializationMethod();
			case MsePackage.LAUNCH_CONFIGURATION__INITIALIZATION_ARGUMENTS:
				return getInitializationArguments();
			case MsePackage.LAUNCH_CONFIGURATION__ADDON_EXTENSIONS:
