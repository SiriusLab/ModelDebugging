 ...
 * @generated
 */
public class Sequential_xdsmlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Sequential_xdsmlPackage.SEQUENTIAL_LANGUAGE_DEFINITION: {
				SequentialLanguageDefinition sequentialLanguageDefinition = (SequentialLanguageDefinition)theEObject;
				T result = caseSequentialLanguageDefinition(sequentialLanguageDefinition);
				if (result == null) result = caseLanguageDefinition(sequentialLanguageDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Sequential_xdsmlPackage.DSA_PROJECT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sequential Language Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sequential Language Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSequentialLanguageDefinition(SequentialLanguageDefinition object) {
		return null;
	}
