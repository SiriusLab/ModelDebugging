...
/**
 * This is the item provider adapter for a {@link fr.obeo.dsl.debug.DebugTarget} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DebugTargetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_DebugTarget_name_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_DebugTarget_name_feature",
						"_UI_DebugTarget_type"), DebugPackage.Literals.DEBUG_TARGET__NAME, true, false,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_DebugTarget_state_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_DebugTarget_state_feature",
						"_UI_DebugTarget_type"), DebugPackage.Literals.DEBUG_TARGET__STATE, true, false,
				false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	/**
	 * This returns DebugTarget.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DebugTarget_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DebugPackage.Literals.DEBUG_TARGET__THREADS,
