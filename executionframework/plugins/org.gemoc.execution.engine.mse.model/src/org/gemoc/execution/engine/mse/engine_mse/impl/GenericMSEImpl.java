...
public class GenericMSEImpl extends MSEImpl implements GenericMSE {
	/**
	 * The cached value of the '{@link #getCallerReference() <em>Caller Reference</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getActionReference() <em>Action Reference</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
			...
			if (callerReference != oldCallerReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Engine_msePackage.GENERIC_MSE__CALLER_REFERENCE, oldCallerReference, callerReference));
			}
		}
	...
	public void setCallerReference(EObject newCallerReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Engine_msePackage.GENERIC_MSE__CALLER_REFERENCE,
					oldCallerReference, callerReference));
	}
	...
	public EOperation getActionReference() {
		if (actionReference != null && actionReference.eIsProxy()) {
			...
			if (actionReference != oldActionReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Engine_msePackage.GENERIC_MSE__ACTION_REFERENCE, oldActionReference, actionReference));
			}
		}
	...
	public void setActionReference(EOperation newActionReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Engine_msePackage.GENERIC_MSE__ACTION_REFERENCE,
					oldActionReference, actionReference));
	}
