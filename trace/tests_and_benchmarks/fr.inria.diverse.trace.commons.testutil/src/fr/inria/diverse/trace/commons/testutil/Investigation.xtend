...
class Investigation {
	...
	public static def Set<EObject> findObjectsThatPointTo(EObject root, Predicate<EObject> predicateReferencedObject, Set<EObject> pointedObjects) {
	...
	public static def Set<EObject> findObjectsThatPointToObjectsWithoutResource(EObject root, Set<EObject> pointedObjects) {
