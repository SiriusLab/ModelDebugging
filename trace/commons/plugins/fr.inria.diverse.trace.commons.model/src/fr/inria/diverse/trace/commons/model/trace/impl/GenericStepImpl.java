 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.trace.commons.model.trace.impl.GenericStepImpl#getStartingStateRef <em>Starting State Ref</em>}</li>
 *   <li>{@link fr.inria.diverse.trace.commons.model.trace.impl.GenericStepImpl#getEndingStateRef <em>Ending State Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class GenericStepImpl extends StepImpl<GenericState> implements GenericStep {
		...
		if (startingStateRef != null && startingStateRef.eIsProxy()) {
			...
			if (startingStateRef != oldStartingStateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.GENERIC_STEP__STARTING_STATE_REF, oldStartingStateRef, startingStateRef));
			}
		}
	...
	public NotificationChain basicSetStartingStateRef(GenericState newStartingStateRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TracePackage.GENERIC_STEP__STARTING_STATE_REF, oldStartingStateRef, newStartingStateRef);
	...
	public void setStartingStateRef(GenericState newStartingStateRef) {
		if (newStartingStateRef != startingStateRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.GENERIC_STEP__STARTING_STATE_REF, newStartingStateRef, newStartingStateRef));
	}
	...
	public GenericState getEndingStateRef() {
		if (endingStateRef != null && endingStateRef.eIsProxy()) {
			...
			if (endingStateRef != oldEndingStateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.GENERIC_STEP__ENDING_STATE_REF, oldEndingStateRef, endingStateRef));
			}
		}
	...
	public NotificationChain basicSetEndingStateRef(GenericState newEndingStateRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TracePackage.GENERIC_STEP__ENDING_STATE_REF, oldEndingStateRef, newEndingStateRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndingStateRef(GenericState newEndingStateRef) {
		if (newEndingStateRef != endingStateRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.GENERIC_STEP__ENDING_STATE_REF, newEndingStateRef, newEndingStateRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TracePackage.GENERIC_STEP__STARTING_STATE_REF:
				if (startingStateRef != null)
					msgs = ((InternalEObject)startingStateRef).eInverseRemove(this, TracePackage.GENERIC_STATE__STARTED_STEPS_REF, GenericState.class, msgs);
				return basicSetStartingStateRef((GenericState)otherEnd, msgs);
			case TracePackage.GENERIC_STEP__ENDING_STATE_REF:
				if (endingStateRef != null)
					msgs = ((InternalEObject)endingStateRef).eInverseRemove(this, TracePackage.GENERIC_STATE__ENDED_STEPS_REF, GenericState.class, msgs);
