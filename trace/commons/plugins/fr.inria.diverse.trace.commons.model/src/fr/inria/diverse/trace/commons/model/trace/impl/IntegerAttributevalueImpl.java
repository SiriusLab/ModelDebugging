...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Integer Attributevalue</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.trace.commons.model.trace.impl.IntegerAttributevalueImpl#getAttributeValue <em>Attribute Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerAttributevalueImpl extends GenericAttributeValueImpl implements IntegerAttributevalue {
	/**
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.INTEGER_ATTRIBUTEVALUE;
	}
	...
	public void setAttributeValue(int newAttributeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.INTEGER_ATTRIBUTEVALUE__ATTRIBUTE_VALUE, oldAttributeValue, attributeValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.INTEGER_ATTRIBUTEVALUE__ATTRIBUTE_VALUE:
