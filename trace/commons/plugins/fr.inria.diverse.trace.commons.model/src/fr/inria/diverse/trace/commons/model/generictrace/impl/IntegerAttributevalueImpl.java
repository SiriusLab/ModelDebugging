...
public class IntegerAttributevalueImpl extends GenericAttributeValueImpl implements IntegerAttributevalue {
	...
	protected EClass eStaticClass() {
		return GenerictracePackage.Literals.INTEGER_ATTRIBUTEVALUE;
	}
	...
	public void setAttributeValue(int newAttributeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenerictracePackage.INTEGER_ATTRIBUTEVALUE__ATTRIBUTE_VALUE, oldAttributeValue, attributeValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenerictracePackage.INTEGER_ATTRIBUTEVALUE__ATTRIBUTE_VALUE:
