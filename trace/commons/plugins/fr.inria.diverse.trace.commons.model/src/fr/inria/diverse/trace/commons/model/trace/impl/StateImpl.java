 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.trace.commons.model.trace.impl.StateImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StateImpl extends MinimalEObjectImpl.Container implements State {
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectWithInverseResolvingEList.ManyInverse<Value>(Value.class, this, TracePackage.STATE__VALUE, TracePackage.VALUE__STATE);
		}
		return value;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TracePackage.STATE__VALUE:
