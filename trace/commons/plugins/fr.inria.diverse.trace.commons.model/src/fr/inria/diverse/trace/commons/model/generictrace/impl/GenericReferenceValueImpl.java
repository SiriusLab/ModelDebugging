 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.trace.commons.model.generictrace.impl.GenericReferenceValueImpl#getReferenceValue <em>Reference Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenericReferenceValueImpl extends GenericValueImpl implements GenericReferenceValue {
		...
		if (referenceValue != null && referenceValue.eIsProxy()) {
			...
			if (referenceValue != oldReferenceValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GenerictracePackage.GENERIC_REFERENCE_VALUE__REFERENCE_VALUE, oldReferenceValue, referenceValue));
			}
		}
	...
	public void setReferenceValue(EObject newReferenceValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenerictracePackage.GENERIC_REFERENCE_VALUE__REFERENCE_VALUE, oldReferenceValue, referenceValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenerictracePackage.GENERIC_REFERENCE_VALUE__REFERENCE_VALUE:
