 ...
 * @generated
 */
public class ManyStringAttributeValueImpl extends GenericAttributeValueImpl implements ManyStringAttributeValue {
	/**
	...
	protected EClass eStaticClass() {
		return GenerictracePackage.Literals.MANY_STRING_ATTRIBUTE_VALUE;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GenerictracePackage.MANY_STRING_ATTRIBUTE_VALUE__ATTRIBUTE_VALUE:
