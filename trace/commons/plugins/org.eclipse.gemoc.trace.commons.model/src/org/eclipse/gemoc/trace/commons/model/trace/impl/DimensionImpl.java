 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.trace.commons.model.trace.impl.DimensionImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DimensionImpl<ValueSubType extends Value<?>> extends MinimalEObjectImpl.Container implements Dimension<ValueSubType> {
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.DIMENSION;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TracePackage.DIMENSION__VALUES:
