...
public class EcorextAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EcorextSwitch<Adapter> modelSwitch =
		new EcorextSwitch<Adapter>() {
			@Override
			public Adapter caseEcorext(Ecorext object) {
				return createEcorextAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecorext.Ecorext <em>Ecorext</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecorext.ClassExtension <em>Class Extension</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ecorext.Rule <em>Rule</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
