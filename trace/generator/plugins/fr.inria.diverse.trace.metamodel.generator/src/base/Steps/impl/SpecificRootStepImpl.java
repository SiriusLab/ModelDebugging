 ...
 * </p>
 * <ul>
 *   <li>{@link base.Steps.impl.SpecificRootStepImpl#getStartingStateRef <em>Starting State Ref</em>}</li>
 *   <li>{@link base.Steps.impl.SpecificRootStepImpl#getEndingStateRef <em>Ending State Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecificRootStepImpl extends SequentialStepImpl<SpecificStep, SpecificState> implements SpecificRootStep {
		...
		if (startingStateRef != null && startingStateRef.eIsProxy()) {
			...
			if (startingStateRef != oldStartingStateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF, oldStartingStateRef, startingStateRef));
			}
		}
	...
	public NotificationChain basicSetStartingStateRef(SpecificState newStartingStateRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF, oldStartingStateRef, newStartingStateRef);
	...
	public void setStartingStateRef(SpecificState newStartingStateRef) {
		if (newStartingStateRef != startingStateRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF, newStartingStateRef, newStartingStateRef));
	}
	...
	public SpecificState getEndingStateRef() {
		if (endingStateRef != null && endingStateRef.eIsProxy()) {
			...
			if (endingStateRef != oldEndingStateRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF, oldEndingStateRef, endingStateRef));
			}
		}
	...
	public NotificationChain basicSetEndingStateRef(SpecificState newEndingStateRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF, oldEndingStateRef, newEndingStateRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEndingStateRef(SpecificState newEndingStateRef) {
		if (newEndingStateRef != endingStateRef) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF, newEndingStateRef, newEndingStateRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF:
				if (startingStateRef != null)
					msgs = ((InternalEObject)startingStateRef).eInverseRemove(this, StatesPackage.SPECIFIC_STATE__STARTED_STEPS_REF, SpecificState.class, msgs);
				return basicSetStartingStateRef((SpecificState)otherEnd, msgs);
			case StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF:
				if (endingStateRef != null)
					msgs = ((InternalEObject)endingStateRef).eInverseRemove(this, StatesPackage.SPECIFIC_STATE__ENDED_STEPS_REF, SpecificState.class, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SpecificStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF: return StepsPackage.SPECIFIC_STEP__STARTING_STATE_REF;
				case StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF: return StepsPackage.SPECIFIC_STEP__ENDING_STATE_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SpecificStep.class) {
			switch (baseFeatureID) {
				case StepsPackage.SPECIFIC_STEP__STARTING_STATE_REF: return StepsPackage.SPECIFIC_ROOT_STEP__STARTING_STATE_REF;
				case StepsPackage.SPECIFIC_STEP__ENDING_STATE_REF: return StepsPackage.SPECIFIC_ROOT_STEP__ENDING_STATE_REF;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == SpecificStep.class) {
			switch (baseOperationID) {
				case StepsPackage.SPECIFIC_STEP___GET_STARTING_STATE: return StepsPackage.SPECIFIC_ROOT_STEP___GET_STARTING_STATE;
				case StepsPackage.SPECIFIC_STEP___GET_ENDING_STATE: return StepsPackage.SPECIFIC_ROOT_STEP___GET_ENDING_STATE;
				case StepsPackage.SPECIFIC_STEP___BASIC_GET_STARTING_STATE: return StepsPackage.SPECIFIC_ROOT_STEP___BASIC_GET_STARTING_STATE;
				case StepsPackage.SPECIFIC_STEP___BASIC_GET_ENDING_STATE: return StepsPackage.SPECIFIC_ROOT_STEP___BASIC_GET_ENDING_STATE;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.SPECIFIC_ROOT_STEP___GET_STARTING_STATE:
				return getStartingState();
			case StepsPackage.SPECIFIC_ROOT_STEP___GET_ENDING_STATE:
				return getEndingState();
			case StepsPackage.SPECIFIC_ROOT_STEP___BASIC_GET_STARTING_STATE:
				return basicGetStartingState();
			case StepsPackage.SPECIFIC_ROOT_STEP___BASIC_GET_ENDING_STATE:
